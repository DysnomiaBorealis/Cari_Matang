...
import com.example.cari_matang2.databinding.LayoutMarkdownBinding
import com.example.cari_matang2.databinding.LayoutYoutubeBinding
...
class PartsPageAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    var partsPage = mutableListOf<PartsPageItem>()
        set(value) {
            field = value
    ...
    class MarkdownViewHolder(private val markdownBinding: LayoutMarkdownBinding)
        ...
        fun bindItem(partPage: PartsPageItem) {
            val css = Github()
